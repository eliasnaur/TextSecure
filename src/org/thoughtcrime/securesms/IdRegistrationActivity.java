 ...
 *
 */
public class IdRegistrationActivity extends BaseActionBarActivity {
  ...
  public void onCreate(Bundle icicle) {
    ...
    setContentView(R.layout.id_registration_activity);
  ...
  private class CreateButtonListener implements View.OnClickListener {
    ...
    public void onClick(View v) {
      final IdRegistrationActivity self = IdRegistrationActivity.this;
  ...
  private class CancelButtonListener implements View.OnClickListener {
    @Override
    public void onClick(View v) {
      TextSecurePreferences.setPromptedPushRegistration(IdRegistrationActivity.this, true);
